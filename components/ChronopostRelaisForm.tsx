...
interface ChronopostRelaisFormProps {
  codePostal: string
  ville?: string
...
export default function ChronopostRelaisForm({
  codePostal,
  ville,
  onSelect,
  selectedPoint
}: ChronopostRelaisFormProps) {
      ...
      {!selectedPoint && (
        <div className="bg-noir-800/50 border border-noir-700 rounded-lg p-4">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-yellow-500 text-noir-950 font-semibold rounded-lg hover:bg-yellow-400 transition-colors"
          >
