...
import { ShoppingCart, Factory, Droplet, Package } from 'lucide-react'
...
export default function SprayPlusPage() {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      // Charger les formats Spray Plus
      const loadedFormats = await loadSprayPlusFormats()
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 text-center">
          ...
          <h1 className="text-5xl font-bold mb-4 flex items-center justify-center gap-3">
            <Droplet className="w-12 h-12 text-yellow-500" />
            Spray plus
          </h1>
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Spray d'attraction concentré pour renforcer l'efficacité de vos appâts
          </p>
        </div>
